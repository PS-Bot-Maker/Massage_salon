...
spec2_pic = FSInputFile(os.path.join(all_img_dir, 'spec_pic_1.jpg'))
spec3_pic = FSInputFile(os.path.join(all_img_dir, 'spec_pic_1.jpg'))
spec4_pic = FSInputFile(os.path.join(all_img_dir, 'spec_pic_1.jpg'))
