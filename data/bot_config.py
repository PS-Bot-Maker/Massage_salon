...
spec2_pic = FSInputFile(os.path.join(all_img_dir, 'spec2_pic_1.jpeg'))
spec3_pic = FSInputFile(os.path.join(all_img_dir, 'spec3_pic_1.jpg'))
spec4_pic = FSInputFile(os.path.join(all_img_dir, 'spec4_pic_1.jpg'))
